              ...
              <div class="custom-col-3 col-lg-4 product-list-item p-lg-0 effect trigger<?php echo $key+1 ?>" id="product-<?php echo $product['product_id'] ?>">
                  <div class="product-wrapper <?php echo $product['class'] ?>">
                      <div class="product-image lg-w-50">
                          <div class="item">
                              <img class="lazy" src="<?php echo get_template_directory_uri(); ?>/images/logo_new.png" data-src="<?php echo $product['images'][0];?>"  alt="<?php echo $product['title'] ?>" title="<?php echo $product['title'] ?>">
                          </div>
                          <div class="item">
                            <img class="lazy" src="<?php echo get_template_directory_uri(); ?>/images/logo_new.png" data-src="<?php echo $product['images'][1];?>" alt="<?php echo $product['title'] ?>" title="<?php echo $product['title'] ?>">
                          </div>
                          <div class="item">
                              <img class="lazy" src="<?php echo get_template_directory_uri(); ?>/images/logo_new.png" data-src="<?php echo $product['images'][2];?>" alt="<?php echo $product['title'] ?>" title="<?php echo $product['title'] ?>">
                          </div>
                          <div class="item">
                              <img class="lazy" src="<?php echo get_template_directory_uri(); ?>/images/logo_new.png" data-src="<?php echo $product['images'][3];?>" alt="<?php echo $product['title'] ?>" title="<?php echo $product['title'] ?>">
                          </div>
                      </div>
