...
if ( ! class_exists( 'Pado_Plugins' ) ) {
	...
	$MyUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
		'https://main.aheto.co/wp-update/?action=get_metadata&slug=pado-plugins', //Metadata URL.
		__FILE__, //Full path to the main plugin file.
		'pado-plugins' //Plugin slug. Usually it's the same as the name of the directory.
	);
